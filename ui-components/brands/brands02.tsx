...
export default function BrandSocial02() {
  return (
    <div className='bg-bg-white-0 w-full'>
      <div className='mx-auto flex w-full max-w-7xl flex-col gap-8 px-6 py-10 md:gap-10 md:px-7 md:py-16 lg:py-24'>
        <div className='flex flex-col md:items-center'>
          ...
          <h1 className='md:text-title-h3 text-title-h4 text-text-strong-950 mb-4 !font-[550] md:text-center'>
            Powering collaboration at every scale
          </h1>
        ...
        <div className='flex flex-col gap-6 md:gap-10'>
          <div className='flex flex-col gap-1.5'>
            <div className='bg-bg-white-0 border-stroke-soft-200 -ml-6 w-[calc(100%+48px)] border-y py-8 md:ml-0 md:w-full md:px-5 md:py-7 lg:px-12 lg:py-10'>
            ...
            <div className='grid grid-cols-1 gap-1.5 md:grid-cols-3'>
              {testimonials.map((item) => (
                <div
                  key={item.name}
                  className='bg-bg-white-0 border-stroke-soft-200 flex flex-col justify-between gap-7 border-b py-7 last:border-r-0 md:gap-5 md:border-r md:border-b-0 md:p-4 lg:gap-9 lg:p-9'
                >
