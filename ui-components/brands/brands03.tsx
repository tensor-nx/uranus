...
export default function BrandSocial03() {
      ...
      <div className='mx-auto flex w-full max-w-7xl flex-col gap-8 px-3 py-10 pb-8 md:gap-12 md:px-7 md:py-16 lg:py-24'>
        <div className='flex flex-col px-3 md:items-center md:px-0'>
          ...
          <h1 className='md:text-title-h3 text-title-h4 text-text-strong-950 mb-4 !font-[550] md:text-center'>
            Alignment that drives real results
          </h1>
          <p className='text-paragraph-md text-text-sub-600 max-w-[528px] md:text-center'>
            Teams using AlignUI products build faster, design smarter, and
            deliver consistent user experiences across every platform.
          </p>
        </div>
        <div className='flex flex-col gap-4 md:gap-6'>
          <div className='flex flex-col gap-4 md:flex-row md:gap-6'>
            <div className='bg-bg-white-0 border-stroke-soft-200 grid flex-1 grid-cols-2 overflow-hidden rounded-[28px] border md:grid-cols-3 md:rounded-[32px]'>
            ...
            <div className='bg-bg-white-0 border-stroke-soft-200 flex w-full flex-col gap-7 rounded-[28px] border p-7 md:w-[320px] md:shrink-0 md:gap-9 md:rounded-[32px] md:p-9 lg:w-[496px]'>
              <Swiper
                modules={[Navigation]}
                spaceBetween={10}
                slidesPerView={1}
              ...
              >
                {testimonials.map((testimonial, index) => (
                  <SwiperSlide key={index} className='flex !h-auto'>
                    <div className='flex h-full flex-col gap-7 md:gap-9'>
