        ...
        <div className='px-5 py-4'>
          ...
          <div className='flex flex-wrap gap-2'>
            <Tag.Root variant='stroke'>
              <Tag.Icon as={RiSettings2Fill} />
              Settings (36)
              <Tag.DismissButton type='button' />
            </Tag.Root>
            <Tag.Root variant='stroke'>
              <Tag.Icon as={RiShoppingBag2Fill} />
              Orders (4)
              <Tag.DismissButton type='button' />
            </Tag.Root>
            <Tag.Root variant='stroke'>
              <Tag.Icon as={RiAppsFill} />
              Products (2)
              <Tag.DismissButton type='button' />
            </Tag.Root>
          </div>
          ...
          <CommandMenu.Group heading='Results (56)'>
            ...
            <CommandMenu.Item size='medium'>
              ...
              <div className='flex flex-1 flex-col gap-1'>
                <span className='text-label-sm'>Customer communications</span>
                <span className='text-paragraph-xs text-text-sub-600'>
                  Interactions between a business and its customers through
                  various channels.
                </span>
              </div>
            ...
            <CommandMenu.Item size='medium'>
              ...
              <div className='flex flex-1 flex-col gap-1'>
                <span className='text-label-sm'>Customer SMS notification</span>
                <span className='text-paragraph-xs text-text-sub-600'>
                  Automated text messages providing updates or information to
                  customers.
                </span>
              </div>
              <CompactButton.Root variant='ghost' size='medium'>
            ...
            <CommandMenu.Item size='medium'>
              ...
              <div className='flex flex-1 flex-col gap-1'>
                <span className='text-label-sm'>Customize email templates</span>
                <span className='text-paragraph-xs text-text-sub-600'>
                  Tailoring pre-designed email layouts to match branding and
            ...
            <CommandMenu.Item size='medium'>
              ...
              <div className='flex flex-1 flex-col gap-1'>
                <span className='text-label-sm'>Custom order fulfillment</span>
                <span className='text-paragraph-xs text-text-sub-600'>
                  Fulfilling customer orders with tailored or specialized
                  handling
                </span>
              </div>
              <CompactButton.Root variant='ghost' size='medium'>
