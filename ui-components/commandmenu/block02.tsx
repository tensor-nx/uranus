          ...
          <CommandMenu.Group heading='Results (4)'>
            ...
            <CommandMenu.Item size='medium'>
              ...
              <div className='flex flex-col justify-center gap-1'>
                <span className='text-label-sm'>Matthew Johnson</span>
            ...
            <CommandMenu.Item size='medium'>
              ...
              <div className='flex flex-col justify-center gap-1'>
                <span className='text-label-sm'>Laura Perez</span>
                <span className='text-paragraph-xs text-text-sub-600'>
                  laura@alignui.com
                </span>
              </div>
            ...
            <CommandMenu.Item size='medium'>
              ...
              <div className='flex flex-col justify-center gap-1'>
                <span className='text-label-sm'>Wei Chen</span>
                <span className='text-paragraph-xs text-text-sub-600'>
                  wei@alignui.com
                </span>
              </div>
            ...
            <CommandMenu.Item size='medium'>
              ...
              <div className='flex flex-col justify-center gap-1'>
                <span className='text-label-sm'>Lena Müller</span>
                <span className='text-paragraph-xs text-text-sub-600'>
                  lena@alignui.com
                </span>
              </div>
            ...
            <CommandMenu.Item size='medium'>
              ...
              <div className='flex flex-col justify-center gap-1'>
                <span className='text-label-sm'>Juma Omondi</span>
                <span className='text-paragraph-xs text-text-sub-600'>
                  juma@alignui.com
                </span>
              </div>
