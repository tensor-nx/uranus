...
export default function BlockProfileCard() {
  return (
    <div className='flex w-full max-w-[400px] flex-col items-center gap-4 rounded-20 bg-bg-white-0 p-2.5 pt-6 shadow-regular-md'>
      ...
      <div className='text-center'>
        <div className='text-label-lg text-text-strong-950'>
          Thanks for the supporting Wei Chen!
        </div>
      ...
      <div className='flex w-full flex-col items-center gap-4 rounded-xl bg-bg-weak-50 p-5'>
        <div className='text-center'>
          <div className='text-label-md text-text-strong-950'>
            Do you want to share your support?
          </div>
          <div className='mt-1 text-paragraph-sm text-text-sub-600'>
            Click the button below to give them a shoutout and share their work
            with others.
          </div>
        </div>
