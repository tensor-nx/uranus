...
export default function Header02({ announcement = false }: Header02Props) {
  ...
  return (
    <header className='border-stroke-soft-200 relative z-300 flex h-16 w-full items-center justify-between gap-6 border-b bg-bg-white-0 px-6 py-4.5 pr-4.5 lg:h-18 lg:px-11 lg:py-5'>
