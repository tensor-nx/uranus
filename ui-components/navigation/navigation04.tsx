...
const nav: Array<{
  ...
  { label: 'Products', href: '/', isnew: true },
  { label: 'Services', href: '/', navMenu: true },
  { label: 'Pricing', href: '/' },
];
...
export default function Header04({ announcement = false }: Header04Props) {
  ...
  return (
    <header className='border-stroke-soft-200 relative z-100 flex h-16 w-full items-center justify-between gap-6 border-b bg-bg-white-0 px-6 py-4.5 pl-4.5 lg:h-18 lg:px-11 lg:py-5'>
      <div className='flex items-center gap-4 lg:gap-6'>
        ...
        <nav
          aria-label='Primary'
          className={cn(
            'fixed left-0 flex w-full flex-col items-center overflow-auto bg-bg-white-0 transition-all duration-300 lg:static lg:top-0 lg:h-auto lg:w-auto lg:flex-row lg:gap-1 lg:overflow-visible lg:bg-transparent',
            announcement
              ? 'top-26 h-[calc(100dvh-104px)]'
            ...
            >
              {item.navMenu ? (
                ...
                >
                  {item.label}
                  {item.isnew && (
                    <span className='tracking-spacing-tiny-4 bg-information-lighter text-information-base rounded-[5px] px-1.25 py-0.5 text-[9px] leading-[11px] font-medium'>
                      NEW
                    </span>
                  )}
                  <RiArrowDownSLine
              ...
              {item.navMenu && (
                <div
                  ...
                  className={`ease lg:shadow-complex-12 w-full overflow-hidden transition-all duration-500 lg:invisible lg:absolute lg:top-18 lg:left-0 lg:!h-auto lg:opacity-0 lg:group-hover:visible lg:group-hover:opacity-100`}
                >
                  <NavDropdownMenu />
                </div>
              )}
      ...
      <div className='hidden w-110 items-center lg:flex'>
        <Input.Root size='xsmall' className='group/search'>
          <Input.Wrapper>
            <Input.Icon
              as={RiSearch2Line}
            ...
            <Input.Input
              placeholder='Search...'
              className='text-text-strong-950 placeholder:text-text-soft-400'
            />
          </Input.Wrapper>
        </Input.Root>
      </div>
      <div className='relative flex items-center gap-3'>
        <Button.Root
          ...
          size='xsmall'
          asChild
          className='rounded-10 hidden w-full lg:flex lg:h-8 lg:w-auto'
        >
        ...
        <Button.Root
          ...
          mode='ghost'
          size='xsmall'
          className='rounded-10 hidden cursor-pointer lg:flex'
        >
          <Button.Icon
            as={RiMoonClearLine}
            className='text-text-sub-600 size-5'
        ...
        <div className='group/profile flex w-auto cursor-pointer items-center gap-1 bg-transparent p-0'>
          <Image
          ...
          />
          <RiArrowDownSLine className='text-text-sub-600 group-hover:text-text-strong-950 hidden size-5 shrink-0 transition-all duration-300 group-hover/profile:-rotate-180 lg:block' />
        </div>
      </div>
    </header>
  );
