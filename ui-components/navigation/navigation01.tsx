...
const nav: Array<{
  ...
  { label: 'Products', href: '/' },
  { label: 'Services', href: '/', isnew: true },
...
function NavDropdownMenu() {
  return (
    <div className='lg:border-stroke-soft-200 z-500 flex w-full flex-col bg-bg-white-0 lg:flex-row lg:gap-10 lg:border-b lg:p-8 xl:justify-center 2xl:gap-20'>
      <div className='flex flex-col lg:gap-6'>
        ...
        <div className='flex flex-col py-1.5 lg:flex-row lg:items-center lg:gap-2.5 lg:py-0'>
          <Button.Root
            variant='neutral'
            mode='stroke'
            size='xxsmall'
...
export default function Header01({ announcement = false }: Header01Props) {
  ...
  return (
    <header className='border-stroke-soft-200 relative z-400 flex h-16 w-full items-center justify-between gap-6 border-b bg-bg-white-0 px-6 py-4.5 pr-4.5 lg:h-18 lg:px-11 lg:py-5'>
      <div className='flex flex-1 items-center gap-6'>
        ...
        <nav
          ...
          className={cn(
            ...
            announcement
              ? 'top-26 h-[calc(100dvh-189px)]'
              : 'top-16 h-[calc(100dvh-149px)]',
            isMenuOpen
      ...
      <div
        className={`border-stroke-soft-200 fixed bottom-0 left-0 flex w-full items-center gap-3.5 border-t bg-bg-white-0 px-6 py-5.5 transition-all duration-300 lg:relative lg:w-auto lg:gap-3 lg:border-t-0 lg:bg-transparent lg:px-0 lg:py-0 ${isMenuOpen ? 'active visible opacity-100' : 'invisible opacity-0 lg:visible lg:opacity-100'}`}
        data-state={isMenuOpen ? 'open' : 'closed'}
      >
        <Button.Root
          variant='neutral'
