...
import { RiBookmark3Fill, RiMailFill, RiUser3Fill } from '@remixicon/react';
  ...
  return (
    <div className='bg-bg-white-0 py-10 lg:py-24 w-full'>
      <div className='relative mx-auto flex max-w-[1016px] flex-col'>
        <div className='absolute bottom-0 left-1/2 z-1 hidden h-auto w-auto -translate-x-1/2 lg:flex'>
          <Image
            src='https://alignui.com/images/blocks/contact-1-image.svg'
            alt='contact'
            width={1016}
            height={478}
            className='h-119.5 w-254 shrink-0 dark:hidden'
          />
          <Image
            ...
            width={1016}
            height={478}
            className='hidden h-119.5 w-254 shrink-0 dark:block'
          />
        </div>
        <div className='relative z-2 mb-8 flex flex-col px-6 lg:mb-10 lg:items-center lg:px-0'>
          ...
          <p className='text-paragraph-md text-text-sub-600'>
            Partnerships fueled by creativity, strategy, and a shared vision for
            meaningful impact.
          </p>
        </div>
        <div className='relative z-2 flex flex-col items-center px-2 lg:px-0'>
          <form
            action=''
            className='shadow-complex-8 bg-bg-white-0 z-2 mb-8 flex h-auto w-full flex-col gap-4 rounded-3xl p-6 md:w-auto lg:mx-auto lg:w-full lg:max-w-[440px] lg:rounded-4xl lg:p-8'
          >
          ...
          <div className='text-label-sm text-text-soft-400 w-full text-center lg:w-101'>
            Join forward-thinking teams worldwide, collaborate on bold ideas,
            and ,{' '}
